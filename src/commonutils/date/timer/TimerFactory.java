package commonutils.date.timer;
...
public class TimerFactory {
    ...
    public SimpleTimer newSimpleTimer(String name) {
    ...
    public ThreadTimer newThreadTimer(String name, int nThread) {
        checkAlreadyExists(name);
    ...
    public ThreadTimer newSingleThreadTimer(String name) {
        checkAlreadyExists(name);
